...
const [INIT_MEETINGS, INIT_MEETINGS_SUCCESS, INIT_MEETINGS_FAILURE] =
...
const [SEARCH_USERNAME, SEARCH_USERNAME_SUCCESS, SEARCH_USERNAME_FAILURE] =
...
const [DELETE_ITEM, DELETE_ITEM_SUCCESS, DELETE_ITEM_FAILURE] =
...
const [INIT_CART, INIT_CART_SUCCESS, INIT_CART_FAILURE] =
  createRequestActionTypes("meetings/INIT_CART");

// export const clearSuccessFlag = createAction(CLEAR_SUCCESS_FLAG);

export const initMeetings = createAction(INIT_MEETINGS, (user_id) => user_id);
...
export const searchUsername = createAction(SEARCH_USERNAME, (keyword) => {
...
export const deleteCartItem = createAction(DELETE_ITEM, (username) => username);
...
export const initCart = createAction(INIT_CART, (initData) => initData);
...
const initMeetingsSaga = createRequestSaga(
  INIT_MEETINGS,
  meetingsAPI.initMeetings,
);
const listGroupTimeTableSaga = createRequestSaga(
  LIST_GROUP_TIMETABLES,
  meetingsAPI.listGroupTimeTable,
);
const searchUsernameSaga = createRequestSaga(
  SEARCH_USERNAME,
  meetingsAPI.searchUsername,
);
const deleteMeetingGroupSaga = createRequestSaga(
  DELETE_MEETING_GROUP,
  meetingsAPI.deleteMeetingGroup,
);

/// TODO
const uploadMeetingGroupSaga = createRequestSaga(
  UPLOAD_MEETING_GROUP,
  meetingsAPI.uploadMeetingGroup,
);
const updateMeetingGroupSaga = createRequestSaga(
  UPDATE_MEETING_GROUP,
  meetingsAPI.updateMeetingGroup,
);
    ...
    [DELETE_MEETING_GROUP_SUCCESS]: (state, { payload }) => {
      ...
      return {
        ...
        groups: [...state.groups].filter(
          (group) => group.group_id !== payload.group_id,
        ),
      };
    },
